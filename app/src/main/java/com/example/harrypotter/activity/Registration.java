                ...
                if (password.length() >= 8) {
                    ...
                    if (matcher.matches()) {
                        ...
                        try {
                            ...
                            jsonObject.put("password", SHA256.calculateSHA256(password));
                        } catch (JSONException e) {
                            throw new RuntimeException(e);
                        }
                        PostUserRequestTask task = new PostUserRequestTask(jsonObject);
                        task.execute(HTTPHelper.baseUrl + "/users");
    ...
    public class PostUserRequestTask extends HTTPHelper.PostJsonRequestTask {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jsonObject.has("message")) { showMessage(Registration.this, "Пользователь с такой почтой уже существует!"); }
                else {
            ...
            } catch (Exception e) { showErrorMessage(Registration.this); }
        }
    }
}